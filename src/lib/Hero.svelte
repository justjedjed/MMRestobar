...
>
				...
				<div class="container content">
					...
					<div class="cta-row reveal" style="animation-delay:.46s">
						<a href="#menu" class="btn btn-primary">
							{s.cta} <ion-icon name="arrow-forward-outline"></ion-icon></a
						>
	...
	<div class="controls">
		<button class="navbtn prev" aria-label="Previous slide" onclick={prev}
			><ion-icon name="chevron-back"></ion-icon></button
		>
		<button class="navbtn next" aria-label="Next slide" onclick={next}
...
<style>
	...
	.book-fab:hover {
		...
		box-shadow: 0 18px 40px rgba(201, 168, 106, 0.42);
	}
	.book-fab .icon {
		width: 28px;
		height: 28px;
