...
<style>
	...
	.logo-wrap {
		...
		box-shadow:
			...
			0 0 0 1px rgba(201, 168, 106, 0.04);
	...
	.preload-logo {
		...
		display: block;
		object-fit: contain;
		filter: drop-shadow(0 0 18px rgba(201, 168, 106, 0.28))
	...
	@keyframes logoShimmer {
		...
		100% {
			filter: drop-shadow(0 0 18px rgba(201, 168, 106, 0.28))
				drop-shadow(0 6px 24px rgba(0, 0, 0, 0.45)) brightness(1);
		}
		50% {
			filter: drop-shadow(0 0 26px rgba(201, 168, 106, 0.42))
				drop-shadow(0 8px 28px rgba(0, 0, 0, 0.5)) brightness(1.06);
		}
	}
	.ring {
		width: 92px;
