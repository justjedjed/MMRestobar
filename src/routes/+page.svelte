<script lang="ts">
	...
	// preloader timer
	$effect(() => {
		const t: ReturnType<typeof setTimeout> = setTimeout(() => (loading = false), 1400);
...
<svelte:head>
	<title>Michaela's Arabic Restobar — Authentic Arabian Flavors</title>
	<meta
		name="description"
		content="Michaela's Arabic Restobar — Savor authentic Arabian cuisine in San Francisco, Agusan del Sur. Biryani, kebabs, karak tea. Daily 10AM–12AM."
	/>
</svelte:head>
	...
	<section class="testi">
		<div class="container">
			<div class="quote">
				...
				<p>
					I wanted to thank you for that amazing dinner — the food was extraordinary.
					Michaela's feels like home, with flavors that transport you to Arabia.
				</p>
...
<style>
	...
	.testi {
		...
		background:
			...
			url('/assets/images/testimonialbg.webp');
